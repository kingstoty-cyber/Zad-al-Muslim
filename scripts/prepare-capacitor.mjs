...
const files=['index.html','offline.html','privacy.html','styles.css','config.js','data.js','app.js','quran.js','prayer.js','enhancements.js','quran-features.js','quran-audio.js','surah-audio.js','quran-library.js','audio-downloads.js','quran-v48.js','quran-video.js','app-shell.js','native-bridge.js','sw.js','manifest.webmanifest','QURAN_DATA_LICENSE.txt','THIRD_PARTY_ASSETS.txt'];
